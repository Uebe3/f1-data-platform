...
def main():
    ...
    stacks = [
        {
            ...
            'template': 'cloudformation/01-data-lake-foundation.yaml',
            'parameters': {
        ...
        },
        {
            ...
            'template': 'cloudformation/02-glue-etl-jobs.yaml',
            'parameters': {
                'Environment': args.environment,
                'ProjectName': args.project_name,
        ...
        },
        {
            ...
            'template': 'cloudformation/03-athena-analytics.yaml',
            'parameters': {
                'Environment': args.environment,
                'ProjectName': args.project_name,
                # These will be populated from foundation stack outputs
    ...
    for stack_config in stacks:
        ...
        # Upload template
        template_path = template_dir / stack_config['template']
